...
def hospital():
  ...
  TO ENTER A DIFFERENT LOCATION, ENTER 'Y' ELSE ENTER 'N': ''')
    ...
    print(" ")
    time.sleep(5)
    chrome = webdriver.Chrome("/Users/jashveragiwala/Desktop/chromedriver")  # change this if needed
    ...
    if b==1:
        ...
        while z==1:
            ...
            if float_temp > 37:
                ...
                mycon=sqltor.connect(host="localhost",user="root",password="Ganesh2015",database="project") # change this if needed
                cursor=mycon.cursor()
